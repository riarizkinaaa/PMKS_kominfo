                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel2">pendidikan</h5>
                                  ...
                                  <div class="modal-body">
                                    <form action="{{ route('pendidikan.store') }}" method="post">
                                        @csrf
                                      <div class="mb-3">
                                        <label class="col-form-label" for="recipient-name">pendidikan</label>
                                        <input class="form-control" name="pendidikan" type="text" value="">
                                      </div>
