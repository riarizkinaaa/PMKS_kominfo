                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel2">Kecamatan</h5>
                              ...
                              <div class="modal-body">
                                <form action="{{ route('admin.store') }}" method="post">
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <input class="form-control" name="kecamatan" type="text" value="">
                                  </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $dat->kecamatan }}</td>
                                                        <td>
                                                            <form action="{{ route('admin.destroy',$dat->id_kecamatan) }}" method="post">
                                                                @csrf
                                                                @method('delete')
