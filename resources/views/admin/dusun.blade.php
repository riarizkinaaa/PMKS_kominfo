                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel2">nama dusun</h5>
                                  ...
                                  <div class="modal-body">
                                    <form action="{{ route('dusun.store') }}" method="post">
                                        @csrf
                                      <div class="mb-3">
                                        <label class="col-form-label" for="recipient-name">Dusun</label>
                                        <input class="form-control" name="dusun" type="text" value="">
                                      </div>
                                      <div class="mb-3">
                                        <label class="col-form-label" for="recipient-name">Desa</label>
                                        ...
                                        {{-- <input type="text" name="id_desa" id="id_desa"> --}}
                                      </div>
                                      <div class="mb-3">
