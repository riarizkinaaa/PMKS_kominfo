                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel2">pekerjaan</h5>
                              ...
                              <div class="modal-body">
                                <form action="{{ route('pekerjaan.store') }}" method="post">
                                    @csrf
                                  <div class="mb-3">
                                    <label class="col-form-label" for="recipient-name">pekerjaan</label>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('pekerjaan.destroy',$kerja->pekerjaan) }}" method="post">
                                                                @csrf
                                                                @method('delete')
